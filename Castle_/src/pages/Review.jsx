...
const Review = () => {
  return (
    <div>
      <Helmet>
        <meta charSet="utf-8" />
        <title>Review-Castle</title>
        <link rel="canonical" href="http://mysite.com/example" />
      </Helmet>
      <section className="my-8  text-gray-800">
        <div className="container flex flex-col items-center mx-auto mb-12 md:p-10 md:px-12">
          <h1 className="p-4 text-4xl font-semibold text-primary leading-none text-center">
          ...
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
            <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 bg-gray-50">
              <p className="relative px-6 py-1 text-lg italic text-center dark:text-gray-800">
                ...
                “Outstanding work! The team at ArchitectoDesign turned our
                vision into reality. Our dream home in New York stands as a true
                testament to their expertise.”
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  fill="currentColor"
            ...
            <div className="flex flex-col items-center justify-center p-8 rounded-b-lg bg-violet-600 text-gray-50">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQiPFyw2rSjiUMHuoc8OEJB28CSr_sKdT2SBw&usqp=CAU"
                alt=""
          ...
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
            <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 bg-gray-50">
              <p className="relative px-6 py-1 text-lg italic text-center text-gray-800">
                ...
                “Professionalism at its best. The architects paid keen attention
                to every detail, and the outcome exceeded our expectations. Our
                California home is now a masterpiece.”
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  fill="currentColor"
