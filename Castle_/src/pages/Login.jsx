...
const Login = () => {
  ...
  return (
    <div className="container mx-auto ">
      ...
      <div className=" md:w-3/4 lg:w-1/2 mx-auto  my-6 gap-4 flex justify-center">
        <div>
          <button
            onClick={() => handleSocialLogin(googleLogin)}
            aria-label="Login with Google"
            type="button"
            className="flex items-center justify-center  p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-violet-600"
          >
            <svg
